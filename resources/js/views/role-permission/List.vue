<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column
        v-if="checkPermission(['system.admin.permission'])"
        align="center"
        label="Actions"
        width="200"
      >
    ...
    <el-dialog
      ...
      :title="'Edit Permissions - ' + currentRole.name"
    >
  ...
  methods: {
    ...
    normalizePermission(permission) {
      return {
        ...
        disabled: permission.name === 'system.admin.permission',
      };
    },
    ...
    confirmPermission() {
      ...
      roleResource
        .update(this.currentRole.id, { permissions: checkedPermissions })
        .then(response => {
          this.$message({
